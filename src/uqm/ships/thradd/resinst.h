...
#define REPULSOR_BIG_MASK_PMAP_ANIM "ship.thraddash.graphics.repulsor.large"
#define REPULSOR_MED_MASK_PMAP_ANIM "ship.thraddash.graphics.repulsor.medium"
#define REPULSOR_SML_MASK_PMAP_ANIM "ship.thraddash.graphics.repulsor.small"
