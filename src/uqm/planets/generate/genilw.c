...
static bool
GenerateIlwrath_generateOrbital (SOLARSYS_STATE *solarSys, const PLANET_DESC *world)
{
...
static COUNT
GenerateIlwrath_generateEnergy (SOLARSYS_STATE *solarSys, const PLANET_DESC *world,
		COUNT whichNode)
{
	if (matchWorld (solarSys, world, 0, MATCH_PLANET))
	{
...
static bool
GenerateIlwrath_pickupEnergy (SOLARSYS_STATE *solarSys, const PLANET_DESC *world,
		COUNT whichNode)
{
	if (matchWorld (solarSys, world, 0, MATCH_PLANET))
	{
